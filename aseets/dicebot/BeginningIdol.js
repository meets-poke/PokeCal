...
(function(Opal) {
  ...
  Opal.add_stubs(['$setPrefixes', '$check_nD6', '$==', '$<=', '$>=', '$upcase', '$===', '$to_i', '$rollPerformance', '$textFrom1D6Table', '$textFromD66Table', '$roll', '$%', '$getD66', '$assoc', '$getSkillList', '$badStatus', '$+', '$[]', '$-', '$getSkillText', '$=~', '$getItem', '$get_table_by_1d6', '$index', '$nil?', '$push', '$setArrayFromD66Table', '$sort!', '$each', '$gsub', '$length', '$include?', '$costume', '$<', '$>', '$!', '$empty?', '$split', '$count', '$join', '$uniq', '$inject', '$map', '$to_proc', '$delete', '$to_s', '$sort', '$checkChance', '$replaceBadStatus', '$chomp', '$get_table_by_2d6', '$times', '$sub', '$clone', '$first']);
