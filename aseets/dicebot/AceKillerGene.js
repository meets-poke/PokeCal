...
(function(Opal) {
  ...
  Opal.add_stubs(['$require', '$setPrefixes', '$===', '$to_i', '$get_critical_border', '$check_roll_repeat_attack', '$look_up_damage_chart']);
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    return (Opal.defn(self, '$rollDiceCommand', TMP_AceKillerGene_rollDiceCommand_4 = function $$rollDiceCommand(command) {
      ...
      success_rate = (($a = $gvars['~']) === nil ? nil : $a['$[]'](2)).$to_i();
      repeat_count = ($truthy($a = (($b = $gvars['~']) === nil ? nil : $b['$[]'](4))) ? $a : 1).$to_i();
      critical_border_text = (($a = $gvars['~']) === nil ? nil : $a['$[]'](6));
      critical_border = self.$get_critical_border(critical_border_text, success_rate);
      return self.$check_roll_repeat_attack(success_rate, repeat_count, critical_border);}
      else if (/^DC(SL|BL|IM|BR|RF|EL)(\d+)/i['$===']($case)) {
      type = (($a = $gvars['~']) === nil ? nil : $a['$[]'](1));
