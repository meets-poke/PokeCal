  ...
  return (function($base, $super, $parent_nesting) {
    ...
    Opal.defn(self, '$checkRoll', TMP_FilledWith_checkRoll_6 = function $$checkRoll(command) {
      ...
      if ($truthy(/(\d[\+\-\d]*)-(\d+)FW(\@(\d+))?(\#(\d+))?/i['$==='](command))) {
        ...
        difficultyText = (($a = $gvars['~']) === nil ? nil : $a['$[]'](1));
        diceCount = (($a = $gvars['~']) === nil ? nil : $a['$[]'](2)).$to_i();
        if ($truthy((($a = $gvars['~']) === nil ? nil : $a['$[]'](3))['$nil?']())) {
          } else {
          crt = (($a = $gvars['~']) === nil ? nil : $a['$[]'](4)).$to_i()
        };
        if ($truthy((($a = $gvars['~']) === nil ? nil : $a['$[]'](5))['$nil?']())) {
          } else {
          fmb = (($a = $gvars['~']) === nil ? nil : $a['$[]'](6)).$to_i()
        };
      } else if ($truthy(/(\d+)FW(\@(\d+))?(\#(\d+))?(<=([\+\-\d]*))?/i['$==='](command))) {
        
        diceCount = (($a = $gvars['~']) === nil ? nil : $a['$[]'](1)).$to_i();
        if ($truthy((($a = $gvars['~']) === nil ? nil : $a['$[]'](2))['$nil?']())) {
          } else {
          crt = (($a = $gvars['~']) === nil ? nil : $a['$[]'](3)).$to_i()
        };
        if ($truthy((($a = $gvars['~']) === nil ? nil : $a['$[]'](4))['$nil?']())) {
          } else {
          fmb = (($a = $gvars['~']) === nil ? nil : $a['$[]'](5)).$to_i()
        };
        difficultyText = (($a = $gvars['~']) === nil ? nil : $a['$[]'](7));
        } else {
        return nil
      };
    ...
    return (Opal.defn(self, '$getRandomEnemyDataResult', TMP_FilledWith_getRandomEnemyDataResult_51 = function $$getRandomEnemyDataResult(command) {
      var $a, self = this, dif = nil, area = nil, event = nil, number = nil, tableName = nil, $case = nil, difficultyText = nil, difficulty = nil, areaText = nil, table = nil, result = nil;
      ...
      if ($truthy(/RED(E|N|H|L)(256|265|465|665|666)/['$==='](command))) {
        ...
        dif = (($a = $gvars['~']) === nil ? nil : $a['$[]'](1));
        area = 0;
        event = (($a = $gvars['~']) === nil ? nil : $a['$[]'](2)).$to_i();
        number = event;
      } else if ($truthy(/RED(E|N|H|L)([1-6])4([1-6])/['$==='](command))) {
        
        dif = (($a = $gvars['~']) === nil ? nil : $a['$[]'](1));
        area = (($a = $gvars['~']) === nil ? nil : $a['$[]'](2)).$to_i();
        event = (($a = $gvars['~']) === nil ? nil : $a['$[]'](3)).$to_i();
        number = "" + (area) + "4" + (event);
        } else {
        return nil
      };
